            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputTitle" type="text" name="title" placeholder="Enter title"
                            value="{{ old('title') }}" class="form-control" required tabindex="1">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" tabindex="2">{{ old('description') }}</textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>

                    {{-- Link type, discount, and redirect --}}
                    <div class="row">
                        {{-- Link type --}}
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="link_type" class="col-form-label">Link Type <span class="text-danger">*</span></label>
                                <select name="link_type" id="link_type" class="form-control" tabindex="3">
                        ...
                        <div class="col-md-8" id="discount-field"
                            ...
                            <div class="form-group">
                                ...
                                <select name="discount_id" id="discount_id" class="form-control" tabindex="4">
                        ...
                        <div class="col-md-8" id="link-field"
                            ...
                            <div class="form-group">
                                ...
                                <input id="link" type="text" name="link"
                                    ...
                                    value="{{ old('link') }}" class="form-control" tabindex="4">
                                @error('link')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group mb-3">
                        <button type="reset" class="btn btn-warning" tabindex="8">Reset</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" required tabindex="5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-btn">
                                <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary" tabindex="6">
                                    <i class="fa fa-picture-o"></i> Choose
                                </a>
                            </span>
                            <input id="thumbnail" class="form-control" type="text" name="photo"
                                value="{{ old('photo') }}" required readonly tabindex="7">
                        </div>
                    ...
                    <div id="image-preview-area" style="margin-top: 15px;">
                        <div id="selected-images" style="display: none;">
                            <label class="text-muted small">Selected Banner Image Preview:</label>
...
<style>
    ...
    /* Image preview styles - Same as edit page */
    #image-preview-area {
        position: relative;
    }
...
<script>
    ...
    function updateImagePreview() {
        ...
        let $holder = $('#holder');
        let $selectedImagesDiv = $('#selected-images');
        ...
        if (!imageInput) {
            ...
            $selectedImagesDiv.hide();
            return;
        }

        console.log('Selected banner image found:', imageInput);

        // Show selected image section with animation
        $selectedImagesDiv.addClass('preview-show').show();

        // Create image container with same structure as edit page
        let container = $('<div class="image-container"></div>');

        // Create image preview with same classes as edit page
        let img = $('<img />', {
            src: imageInput,
            class: 'img-thumbnail image-preview',
            alt: 'Selected Banner Image',
            'data-fallback-text': 'Selected Banner Image',
            tabindex: 8 // Make image focusable for zooming
        });
        ...
        console.log('Selected banner image preview created');
    }
    ...
    $(document).ready(function() {
        console.log('Document ready - Banner Create Form');
