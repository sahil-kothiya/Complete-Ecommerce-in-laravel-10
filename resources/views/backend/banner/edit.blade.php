            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" tabindex="2">{{ old('description', $banner->description) }}</textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <button type="reset" class="btn btn-warning" tabindex="7">Reset</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="thumbnail" class="form-control" type="text" name="photo" value="{{old('photo', $banner->photo)}}" required readonly tabindex="7">
                        </div>
