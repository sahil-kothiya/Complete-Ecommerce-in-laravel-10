...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        ...
        <a href="{{ route('discount.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" title="Add Discount" tabindex="0">
            ...
            <table class="table table-bordered" id="discount-dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('discount.edit', $discount->id) }}" class="btn btn-primary btn-sm mr-1" style="height:30px; width:30px; border-radius:50%;" title="Edit" tabindex="0">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="{{ route('discount.destroy', $discount->id) }}" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-danger btn-sm dltBtn" data-id="{{ $discount->id }}" style="height:30px; width:30px; border-radius:50%;" title="Delete" tabindex="0">
