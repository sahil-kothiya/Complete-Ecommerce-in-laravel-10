<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<!-- Discount -->
	<li class="nav-item">
		<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#discountCollapse" aria-expanded="true" aria-controls="discountCollapse">
			<i class="fas fa-percentage"></i>
			<span>Discount</span>
		</a>
		<div id="discountCollapse" class="collapse" aria-labelledby="headingDiscount" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">Discount Options:</h6>
				<a class="collapse-item" href="{{ route('discount.index') }}">Discount List</a>
				<a class="collapse-item" href="{{ route('discount.create') }}">Add Discount</a>
			</div>
		</div>
	</li>
