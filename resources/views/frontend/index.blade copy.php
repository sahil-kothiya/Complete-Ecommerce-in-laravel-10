    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-12 text-center">
                <div class="filter-tope-group justify-content-center" role="tablist" aria-label="Product category filters">
                    <button class="btn filter-btn active" 
                            role="tab" 
                            aria-selected="true" 
                            aria-controls="productsGrid"
                            data-filter="*"
                            id="tab-all">All Products</button>
                    ...
                    <button class="btn filter-btn" 
                            ...
                            id="tab-{{ $cat->id }}">{{ $cat->title }}</button>
                    @endforeach
                </div>
            </div>
        </div>
        ...
        <!-- WRAPPER: Ensures cards are centered -->
        <div class="d-flex flex-wrap justify-content-center gap-4" id="productsGrid" role="tabpanel" aria-labelledby="tab-all">
            <div class="product-listing-wrapper isotope-grid">
                @foreach($product_lists->take(60) as $product)
                    <div class="product-card-container isotope-item category-{{ $product->cat_id }}">
...
<section class="shop-home-list section">
    <div class="container">
        ...
        <div class="row">
            @foreach($product_lists->take(0) as $product)
            <div class="col-md-4">
...
<style>
    ...
    .filter-tope-group .filter-btn[aria-selected="true"] {
...
<script>
    $(document).ready(function() {
        document.addEventListener("DOMContentLoaded", function() {
            ...
            filterButtons.forEach(btn => {
                btn.addEventListener("click", () => {
                    ...
                    if (productsGrid) {
                        productsGrid.setAttribute("aria-labelledby", btn.id);
                    }
                });
            });
        });
        ...
        $(function () {
            ...
            // Wait until all images in grid are loaded before initializing Isotope
            ...
            // Filter logic
            $('.filter-tope-group').on('click', '.filter-btn', function () {
