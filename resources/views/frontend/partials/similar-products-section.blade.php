                        ...
                        <div class="carousel-item flipkart-card" tabindex="{{ $tabindex }}">
                            <div class="flipkart-card-img-wrap">
                                <a href="{{ route('product-detail', $product->slug) }}">
                                    <img src="{{ $product->images->first() ? $product->images->first()->url : asset('images/no-image.png') }}"
                                        alt="{{ $product->title }}" class="flipkart-card-img" loading="lazy">
                                </a>
                            ...
                            <div class="flipkart-card-body">
                                ...
                                <div class="flipkart-card-price">
                                    @if ($product->discount > 0)
                                        <span
                                            class="flipkart-price-discounted">${{ number_format($product->price - ($product->price * $product->discount) / 100, 2) }}</span>
                                        <span
                                            class="flipkart-price-original">${{ number_format($product->price, 2) }}</span>
                                    @else
                                        <span
                                            class="flipkart-price-discounted">${{ number_format($product->price, 2) }}</span>
                                    @endif
                                </div>
