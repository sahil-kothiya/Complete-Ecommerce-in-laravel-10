                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-ratting-review">
                                        <div class="quickview-ratting-wrap">
                                            <div class="quickview-ratting">
                                                @php
                                                    $rate = DB::table('product_reviews')
                                                        ...
                                                        ->avg('rate');
                                                    $rateCount = DB::table('product_reviews')
                                                        ->where('product_id', $product->id)
                                                        ->count();
                                                @endphp
                                                @for ($i = 1; $i <= 5; $i++)
                                            ...
                                            <a href="#">({{ $rateCount }} customer
                                                review{{ $rateCount == 1 ? '' : 's' }})</a>
                                        </div>
                                        <div class="quickview-stock">
                                            @if ($product->stock > 0)
                                                <span><i class="fa fa-check-circle-o"></i> {{ $product->stock }} in
                                                    stock</span>
                                            @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> Out of
                                                    stock</span>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="quantity">
                                            <div class="input-group">
                                                <div class="button minus">
                                                    <button type="button" class="btn btn-primary btn-number" disabled
